...
input CommentUpdateInput {
  title: String
  body: String
  queue: QueueUpdateOneRequiredInput
...
input QueueUpdateOneRequiredInput {
  create: QueueCreateInput
  update: QueueUpdateDataInput
  upsert: QueueUpsertNestedInput
  connect: QueueWhereUniqueInput
}

input QueueUpsertNestedInput {
  update: QueueUpdateDataInput!
  create: QueueCreateInput!
}
